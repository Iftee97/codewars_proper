...
function animals(heads, legs) {
    ...
    // chickens and cows both have one head each
    // chickens have 2 legs, while cows have 4

    // we gotta solve by using simultaneous equations

    // cows + chickens = heads;
    // 4*cows + 2*chickens = legs;

    chickens = Math.abs((legs - (4 * heads)) / (-2));
    cows = Math.abs(heads - chickens);
